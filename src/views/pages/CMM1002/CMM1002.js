...
export class CMM1002 extends React.Component {
    ...
    state = {
        ...
        rowData_1: [],
        columnDefs_0: [
            { headerName: "대분류코드", field: "CATE_CD" },
            { headerName: "대분류코드명", field: "CATE_NM" },
        ...
        columnDefs_1: [
            { headerName: "중분류코드", field: "CATE_CD", width: 150 },
            { headerName: "중분류코드명", field: "CATE_NM", width: 250 },
    ...
    searchMCateMst = (e) => {
        ...
        let params = {
            CATE_CD: selected[0].CATE_CD
        };
        this.grid_1_api.sizeColumnsToFit();
        axios.post('/common/mcate_mst', params)
            .then(res => {
                        ...
                        <Grid container spacing={1}>
                            <Grid container item xs>
                                <div style={{ width: '100%', height: '30px', marginTop: '10px' }}>
                                    <div style={{ float: 'left' }}><h5># 시험대분류</h5></div>
                            ...
                            <Grid container item xs>
                                <div style={{ width: '100%', height: '30px', marginTop: '10px' }}>
                                    <div style={{ float: 'left' }}><h5># 시험중분류</h5></div>
                                    <div style={{ float: 'right', marginBottom: '5px' }}>
                                        <Button variant="outlined" onClick={() => this.add('1')} >행추가</Button>
